...
[homelab-core-dns](https://github.com/priyankub/homelab-core-dns)'s
`roles/mariadb_galera`, so `garbd` and the nodes' `libgalera_smm` track the
same `galera-4` release.
